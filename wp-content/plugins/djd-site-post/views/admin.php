...
add_settings_field('djd_site_post_type', __('Form Type', 'djd-site-post'), 'djd_site_post_type', 'djd-site-post-plugin', 'djd_site_post_plugin_main');
...
function djd_site_post_type() {
    $options = get_option('djd_site_post_settings');
    echo "<input type='text' id='djd-post-type' class='regular-text' name='djd_site_post_settings[djd-post-type]' value='{$options['djd-post-type']}' size='40' /> ";
}
...
function djd_site_post_show_tags() {
    $options = get_option('djd_site_post_settings');
	$showTags = '';
	if(isset($options['djd-show-tags'])){
		$showTags = $options['djd-show-tags'];
	}
	?>
    <input type='checkbox' id='djd-show-tags' name='djd_site_post_settings[djd-show-tags]' value='1' <?php checked(1, $showTags); ?> />
    <?php
...
function djd_site_post_guest_info() {
    $options = get_option('djd_site_post_settings');
	$guestInfo = '';
	if(isset($options['djd-guest-info'])){
		$guestInfo = $options['djd-guest-info'];
	}
	?>
    <input type='checkbox' id='djd-guest-info' name='djd_site_post_settings[djd-guest-info]' value='1' <?php checked(1, $guestInfo); ?> />
    <?php
...
function djd_site_post_title_required() {
    $options = get_option('djd_site_post_settings');
	$titleRequired = '';
	if(isset($options['djd-title-required'])){
		$titleRequired = $options['djd-title-required'];
	}
	?>
    <input type='checkbox' id='djd-title-required' name='djd_site_post_settings[djd-title-required]' value='1' <?php checked(1, $titleRequired); ?> />
    <?php
...
function djd_site_post_show_excerpt() {
    $options = get_option('djd_site_post_settings');
	$showExcerpt = '';
	if(isset($options['djd-show-excerpt'])){
		$showExcerpt = $options['djd-show-excerpt'];
	}
	?>
    <input type='checkbox' id='djd-show-excerpt' name='djd_site_post_settings[djd-show-excerpt]' value='1' <?php checked(1, $showExcerpt); ?> />
    <?php
...
function djd_site_post_show_content() {
    $options = get_option('djd_site_post_settings');
	$showContent = '';
	if(isset($options['djd-show-content'])){
		$showContent = $options['djd-show-content'];
	}
	?>
    <input type='checkbox' id='djd-show-content' name='djd_site_post_settings[djd-show-content]' value='1' <?php checked(1, $showContent); ?> />
    <?php
...
function djd_site_post_mail() {
    $options = get_option('djd_site_post_settings');
	$djdMail = '';
	if(isset($options['djd-mail'])){
		$djdMail = $options['djd-mail'];
	}
	?>
    <input type='checkbox' id='djd-mail' name='djd_site_post_settings[djd-mail]' value='1' <?php checked(1, $djdMail); ?> />
    <?php
...
function djd_site_post_allow_new_category() {
    $options = get_option('djd_site_post_settings');
	$allowNewCategory = '';
	if(isset($options['djd-allow-new-category'])){
		$allowNewCategory = $options['djd-allow-new-category'];
	}
	?>
    <input type='checkbox' id='djd-allow-new-category' name='djd_site_post_settings[djd-allow-new-category]' value='1' <?php checked(1, $allowNewCategory); ?> />
    <?php
...
function djd_site_post_allow_media_upload() {
    $options = get_option('djd_site_post_settings');
	$allowMediaUpload = '';
	if(isset($options['djd-allow-media-upload'])){
		$allowMediaUpload = $options['djd-allow-media-upload'];
	}
	?>
    <input type='checkbox' id='djd-allow-media-upload' name='djd_site_post_settings[djd-allow-media-upload]' value='1' <?php checked(1, $allowMediaUpload); ?> />
    <?php
...
function djd_site_post_login_link () {
    $options = get_option('djd_site_post_settings');
	$loginLink = '';
	if(isset($options['djd-login-link'])){
		$loginLink = $options['djd-login-link'];
	}
	?>
    <input type='checkbox' id='djd-login-link' name='djd_site_post_settings[djd-login-link]' value='1' <?php checked(1, $loginLink); ?> />
    <?php
...
function djd_site_post_post_format () {
    $options = get_option('djd_site_post_settings');
	$postFormat = '';
	if(isset($options['djd-post-format'])){
		$postFormat = $options['djd-post-format'];
	}
	?>
    <input type='checkbox' id='djd-post-format' name='djd_site_post_settings[djd-post-format]' value='1' <?php checked(1, $postFormat); ?> />
    <?php
...
function djd_site_post_hide_toolbar () {
    $options = get_option('djd_site_post_settings');
	$hideToolbar = '';
	if(isset($options['djd-hide-toolbar'])){
		$hideToolbar = $options['djd-hide-toolbar'];
	}
	?>
    <input type='checkbox' id='djd-hide-toolbar' name='djd_site_post_settings[djd-hide-toolbar]' value='1' <?php checked(1, $hideToolbar); ?> />
    <?php
...
function djd_site_post_no_backend () {
    $options = get_option('djd_site_post_settings');
	$noBackend = '';
	if(isset($options['djd-no-backend'])){
		$noBackend = $options['djd-no-backend'];
	}
	?>
    <input type='checkbox' name='djd_site_post_settings[djd-no-backend]' value='1' <?php checked(1, $noBackend); ?> />
    <?php
...
function djd_site_post_hide_edit () {
    $options = get_option('djd_site_post_settings');
	$hideEdit = '';
	if(isset($options['djd-hide-edit'])){
		$hideEdit = $options['djd-hide-edit'];
	}
	?>
    <input type='checkbox' id='djd-hide-edit' name='djd_site_post_settings[djd-hide-edit]' value='1' <?php checked(1, $hideEdit); ?> />
    <?php
...
function djd_site_post_allow_guest_posts() {
    $options = get_option('djd_site_post_settings');
	$allowGuestPost = '';
	if(isset($options['djd-allow-guest-posts'])){
		$allowGuestPost = $options['djd-allow-guest-posts'];
	}
	?>
    <input type='checkbox' id='djd-allow-guest-posts' name='djd_site_post_settings[djd-allow-guest-posts]' value='1' <?php checked(1, $allowGuestPost); ?> />
    <?php
...
function djd_site_post_guest_cat_select() {
    $options = get_option('djd_site_post_settings');
	$allowSelectCategory = '';
	if(isset($options['djd-guest-cat-select'])){
		$allowSelectCategory = $options['djd-guest-cat-select'];
	}
	?>
    <input type='checkbox' id='djd-guest-cat-select' name='djd_site_post_settings[djd-guest-cat-select]' value='1' <?php checked(1, $allowSelectCategory); ?> />
    <?php
...
function djd_site_post_quiz() {
    $options = get_option('djd_site_post_settings');
	$quiz = '';
	if(isset($options['djd-quiz'])){
		$quiz = $options['djd-quiz'];
	}
    ?>
    <input type='checkbox' id='djd-quiz' name='djd_site_post_settings[djd-quiz]' value='1' <?php checked(1, $quiz); ?> />
    <?php
