	...
	<div id="field-wrapper">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<input style="width:100%;" type="text" <?php echo "required='required'"; ?> id="djd_site_post_link" name="djd_site_post_link" maxlength="255" <?php if ( $my_post ) echo "value='".$my_post->post_link."'"; ?>autofocus="autofocus"/>
			</div>
		</div>
